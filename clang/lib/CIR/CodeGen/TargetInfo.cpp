...
public:
  ...
  void setCUDAKernelCallingConvention(cir::CallingConv &conv) const override {
    conv = cir::CallingConv::PTX_Kernel;
  }
}; 
...
public:
  ...
  void setCUDAKernelCallingConvention(cir::CallingConv &conv) const override {
    // HIP kernels use SPIR_KERNEL calling convention for AMDGPU
    conv = cir::CallingConv::SpirKernel;
  }
};
} //namespace
